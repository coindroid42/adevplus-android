...
import com.coinomi.core.coins.AdevplusMain;
...
public class Constants {
    ...
    public static final String BINARY_URL = "https://github.com/Adevplus/Adevplus/releases";

    public static final String VERSION_URL = "http://adevplus.org//version";
    public static final String PARTNERS_URI = "http://adevplus.org//partner.json";
    public static final String SUPPORT_EMAIL = "adevcoin@gmail.com";

    // TODO move to resource files
    public static final List<CoinAddress> DEFAULT_COINS_SERVERS = ImmutableList.of(
            new CoinAddress(AdevplusMain.get(), new ServerAddress("node1.coindroid.org", 64231),
                    new ServerAddress("node1.coindroid.org", 64231))
    ...
    static {
        ...
        COINS_ICONS.put(CoinID.ADEVPLUS_MAIN.getCoinType(), R.drawable.adevplus);


        COINS_BLOCK_EXPLORERS = new HashMap<>();
        COINS_BLOCK_EXPLORERS.put(CoinID.ADEVPLUS_MAIN.getCoinType(), "");
    }
